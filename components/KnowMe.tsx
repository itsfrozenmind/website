  ...
  return (
    <section className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 pb-20">
      <div className="mb-6">
        ...
        <h2 style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.5rem)', fontWeight: 300, color: 'var(--text)' }}>The rest of it</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="hud-card rounded-sm p-6 flex flex-col justify-between">
          <div>
            <p className="mono mb-3" style={{ color: 'var(--muted)' }}>IF YOU&apos;VE SCROLLED THIS FAR</p>
            <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.8rem', lineHeight: 1.2, fontWeight: 300, marginBottom: '0.75rem', color: 'var(--text)' }}>
          ...
          <Link href="/watch" className="inline-flex items-center mono mt-6 px-4 py-2 rounded-sm self-start transition-colors hover:border-[var(--accent)] hover:text-[var(--text)]"
